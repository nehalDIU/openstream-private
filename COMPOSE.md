...
The current design of Openstream loosely uses the MVVM architecture.
...
This is part of the effort to make Openstream cross platform, as it allows us to decouple UI and logic.
