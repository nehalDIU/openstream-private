...
// When absent (e.g. CI or another machine), the release build falls back to the debug signing config.
...
android {
    ...
    signingConfigs {
        ...
        // Stable release signing, read from a gitignored keystore.properties.
        if (keystorePropertiesFile.exists()) {
            create("release") {
