...
object PluginManager {
    ...
    suspend fun downloadPlugin(
        ...
        try {
            ...
            if (res) {
                com.lagradost.cloudstream3.analytics.AnalyticsManager.logExtensionInstalled(internalName, internalName, 1)
            }
            return res
        } catch (e: Exception) {
            com.lagradost.cloudstream3.analytics.AnalyticsManager.logExtensionFailed(internalName, e.message)
            logError(e)
            return false
        }
    }
