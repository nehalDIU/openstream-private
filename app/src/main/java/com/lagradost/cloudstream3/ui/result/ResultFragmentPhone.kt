...
open class ResultFragmentPhone : BaseFragment<FragmentResultSwipeBinding>(
    ...
    override fun onBindingCreated(binding: FragmentResultSwipeBinding, savedInstanceState: Bundle?) {
        ...
        // ===== setup =====
        val storedData = getStoredData() ?: return
        com.lagradost.cloudstream3.analytics.AnalyticsManager.logScreen("Movie Details")
        com.lagradost.cloudstream3.analytics.AnalyticsManager.logMovieOpen(
            title = storedData.name,
            id = storedData.url,
            provider = storedData.apiName,
            type = "Movie/TV",
            language = "en"
        )
