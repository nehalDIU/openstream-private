...
class SearchFragment : BaseFragment<FragmentSearchBinding>(
    ...
    fun search(query: String?) {
        ...
        com.lagradost.cloudstream3.analytics.AnalyticsManager.logSearch(query, 0)
    ...
    override fun onBindingCreated(
        ...
        com.lagradost.cloudstream3.analytics.AnalyticsManager.logScreen("Search")
        reloadRepos()
        binding.apply {
            val adapter =
                SearchAdapter(
        ...
        binding.searchFilter.setOnClickListener { searchView ->
            searchView?.context?.let { ctx ->
                ...
                fixSystemBarsPadding(selectMainpageBinding.root, padTop = false, padBottom = true)
                builder.show()
                builder.let { dialog ->
